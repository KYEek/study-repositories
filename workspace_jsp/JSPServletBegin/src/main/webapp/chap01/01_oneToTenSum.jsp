...
<body>
	...
	*/
	...
	HTML 주석문은 소스보기에서 그대로 보여집니다. JSP 주석문은 소스보기에서 안 보여집니다.

	<!--HTML주석문은 소스보기에서 그대로 보여집니다.-->
	<%-- JSP 주석문은 소스보기에서 보이지 않습니다. --%>
	...
	<% 로 시작하여 %> 로 끝나는 것을 "스크립틀릿(scriptlet)" 이라고 부른다.
      ...
      확장자가 .java인 파일로 저장되어서 컴파일 되어진
      확장자가 .class인 파일로 저장되어지는데
      어느 경로제 저장되어지는지는 알아야 한다.
      
      C:\NCS\workspace_jsp\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\work\Catalina\localhost\JSPServletBegin\org\apache\jsp\chap01\_01_005foneToTenSum_jsp.class
      C:\NCS\workspace_jsp\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\work\Catalina\localhost\JSPServletBegin\org\apache\jsp\chap01\_01_005foneToTenSum_jsp.java
      저장된다.
	...
	<h2>
		1부터 10까지의 합은 <span id="result_1"><%=sum%></span> 입니다.
	</h2>

	<hr style="border: solid 1px green;">

	<h2>
		1부터 10까지의 합의 10배는 <span id="result_2"><%=sum * 10%></span> 입니다.
	</h2>
	안녕하세요 ^^~~
</body>
</html>