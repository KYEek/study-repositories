...
<body>
	<h2 style="background-color: navy; color: white">forTokens 를 이용하여
		친구이름 출력하기, split 함수를 이용하여 친구이름 출력하기</h2>
	...
	<c:if test="${empty requestScope.friend_name_2 == null}">
		<div>
			<span style="color: red;">친구가 없으시군요</span>
		</div>
	</c:if>
	<c:if test="${not empty requestScope.friend_name_2 != null}">
		<div>
			<ol>
	...
	<h2 style="background-color: navy; color: white">split 함수를 사용하여 배열로 만든 다음 forEach로 실행하기</h2>	
