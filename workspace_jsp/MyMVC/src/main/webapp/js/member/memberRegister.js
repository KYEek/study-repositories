...
// "아이디중복확인" 을 클릭했는지 클릭은 안 했는지 여부를 알아오기 위한 용도

let b_emailcheck_click = false;
// "이메일중복확인" 을 클릭했는지 클릭은 안 했는지 여부를 알아오기 위한 용도
    ...
    */    
        ...
        //  async : true,   // async:true 가 비동기 방식을 말한다. async 을 생략하면 기본값이 비동기 방식인 async:true 이다.
            ...
            success : function(json){
                ...
                // {"isExists":true}
                // {"isExists":false}
                // json 은 idDuplicateCheck.up 을 통해 가져온 결과물인 "{"isExists":true}" 또는 "{"isExists":false}" 로 되어지는 string 타입의 결과물이다. 
    ...
    // 아이디값이 변경되면 가입하기 버튼을 클릭시 "아이디중복확인" 을 클릭했는지 클릭안했는지 알아보기위한 용도 초기화 시키기 
        ...
        //  async:true,  // async:true 가 비동기 방식을 말한다. async 을 생략하면 기본값이 비동기 방식인 async:true 이다.
            ...
            success:function(json){
                if(json.isExists) {
                    ...
                    $("span#emailCheckResult").html($("input#email").val() + " 은 이미 사용가능 합니다").css({"color":"navy"});
                }
            },                    
    ...
    // 이메일값이 변경되면 가입하기 버튼을 클릭시 "이메일중복확인" 을 클릭했는지 클릭안했는지 알아보기위한 용도 초기화 시키기 
