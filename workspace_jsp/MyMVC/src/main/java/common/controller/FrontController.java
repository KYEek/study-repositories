...
@WebServlet(description = "사용자가 웹에서 *.up 을 했을 경우 이 서블릿이 응답을 해주도록 한다.", urlPatterns = { "*.up" }, initParams = {
...
//		System.out.println("확인용" +props);
		...
		try {
			...
			// fis 는 C:/NCS/workspace_jsp/MyMVC/src/main/webapp/WEB-INF/Command.properties
