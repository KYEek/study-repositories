...
public class CoinUpdateLoginUser extends AbstractController {
	...
	public void execute(HttpServletRequest request, HttpServletResponse respone) throws Exception {
		...
		String method = request.getMethod(); // "GET" 또는 "POST"
	      ...
	      jsonObj.put("message", message); // {"n":1, "message":"연규영님의 300,000원 결제가 완료되었습니다."} 
	      jsonObj.put("loc", loc);         // {"n":1, "message":"연규영님의 300,000원 결제가 완료되었습니다.", "loc":"/MyMVC/index.up"}   
	      
	      String json = jsonObj.toString();  // "{"n":1, "message":"연규영님의 300,000원 결제가 완료되었습니다.", "loc":"/MyMVC/index.up"}"
