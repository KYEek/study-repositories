...
public class ProjectDBConnection {
    ...
    */ 
	...
	// --> field (첫번째로 작동) <-- //
	// static 변수
	private static Connection conn = null; // 타입은 자기 자신, null은 생략 가능
	...
	static {
		...
		try {
			...
			conn = DriverManager.getConnection("jdbc:oracle:thin:@211.238.142.186:1521:xe", "mini_orauser2", "gclass");
		}
	...
	private ProjectDBConnection() {		//기본은 public 인데 private로 하면 객체를 못만듬
