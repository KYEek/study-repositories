...
public class ArrayList_main_1 {
	...
	public static void main(String[] args) {
		...
		*/
		...
		my_list.add(1234.5);//double --> Double 로 autoBoxing 해준다
		...
		////////////////////////////////////////////////////////////////////////////////////////////
			...
			*/
		/*
		List<String> str_list_1 = new ArrayList<String>(); //JDK 8 이전버전
		List<String> str_list_2 = new ArrayList<>(); //JDK 8 이후버전
		List<> str_list_3 = new ArrayList<String>(); //오류!!
		List<> str_list_2 = new ArrayList<>(); // 오류!!
		*/
		
		List<String> str_list = new ArrayList<>();
		str_list.add("마동석");
//		str_list.add(12345);		//오류
//		str_list.add(12345.678);	//오류
