...
public class Main {
	...
	public void d_method() {
		//SingletonNumber cObj = new SingletonNumber(); // 객체생성
		// 객체생성이 불가하다.
	...
	public void e_method() {
		...
		System.out.println("eObj =>" + eObj);	//같은 클래스를 참조합니다.
	...
	public void f_method() {
		...
		System.out.println("eObj =>" + fObj);	//같은 클래스를 참조합니다.
	...
	public static void main(String[] args) {
		...
		ma.a_method();
		/*
		 aObj =>jdbc.day04.singletonPattern.NoSingletonNumber@24d46ca6
		 a_method() 메소드에서 cnt 값 호출 : 1
		 */

		ma.b_method();
		/*
		 bObj =>jdbc.day04.singletonPattern.NoSingletonNumber@5b2133b1
		...
		ma.c_method();
		/*
		 cObj =>jdbc.day04.singletonPattern.NoSingletonNumber@72ea2f77
		...
		ma.d_method();
		/*
		 dObj =>jdbc.day04.singletonPattern.SingletonNumber@1218025c
		 d_method() 메소드에서 cnt 값 호출 : 1
		 */
		ma.e_method();
		/*
		 eObj =>jdbc.day04.singletonPattern.SingletonNumber@1218025c
