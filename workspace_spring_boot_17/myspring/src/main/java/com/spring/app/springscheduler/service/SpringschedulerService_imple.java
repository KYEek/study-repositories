...
public class SpringschedulerService_imple implements SpringschedulerService {
	...
	// === #210. Spring Scheduler(스프링스케줄러) 연습(매 1분마다 DB에 insert 하기) ===
	// !!<주의>!! 스프링스케줄러로 사용되는 메소드는 반드시 리턴타입은 void 이어야 하고, 파라미터가 없어야 한다.!!!!!!!!!!
	
	// === Spring Scheduler(스프링스케줄러)는 서비스단에서 작업을 하는 것이다. === //
	/*
	     ...
	     * 는 모든 수를 의미.
	     ...
	     위치에 15W로 설정하고 15일이 평일이면 15일에 동작함.
...
//	@Scheduled(cron="0 * * * * *")
	...
	public void test_Scheduler_insert() {
		...
		// 현재시각 => 2025-02-20 09:42:00
		
		Map<String, String> paraMap = new HashMap<>();
		
		paraMap.put("name", "이순신");
		paraMap.put("currentTime", currentTime);
		
		dao.test_insert(paraMap);
