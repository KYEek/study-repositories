...
public class CommentVO {
	...
	/*
        ...
        /myspring/src/main/webapp/WEB-INF/views/mycontent1/board/view.jsp 파일에서 input type="file" 인 name 의 이름(attach) 과 
         동일해야만 파일첨부가 가능해진다.!!!!           
	 */
	private String fileName;     // WAS(톰캣)에 저장될 파일명(2025021109291535243254235235234.png)                                       
