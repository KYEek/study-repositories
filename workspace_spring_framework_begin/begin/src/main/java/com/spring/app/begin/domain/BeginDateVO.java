package com.spring.app.begin.domain;

import java.util.Date;

import org.springframework.format.annotation.DateTimeFormat;

public class BeginDateVO {
...
//  또는
	...
	// 만약에 @DateTimeFormat(pattern="yyyy-MM-dd") 을 생략하면 폼태그로 부터 입력받은 타입은 String 인데 writeday 는 Date 이라서 타입이 맞지 않으므로 "HTTP 상태 400 – 잘못된 요청" 이라고 나온다. 
